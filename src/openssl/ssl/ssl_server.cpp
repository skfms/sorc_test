// g++ -g -o ssl_server -I/home/leegs/com_vender/openssl/include -L/home/leegs/com_vender/openssl/lib -l ssl -l crypto ssl_server.cpp
...
//Only root user have the permsion to run the server
    ...
    LoadCertificates(ctx, "ssl_test.crt", "ssl_test.pem"); /* load certs */
