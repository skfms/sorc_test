// g++ -g -o ASE -I /home/leegs/Project/com_vender/openssl/include -L /home/leegs/Project/com_vender/openssl/lib ASE.c base64.c -l crypto
...
)
{
	...
	memcpy(keyCipher, _key, strlen(_key));
	memcpy(iv, _iv, strlen(_iv));
