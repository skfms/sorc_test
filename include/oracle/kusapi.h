...
typedef void  *kusdb_handle;    /* handle for connected database */
typedef void  *kuscx_handle;    /* handle for continuation context */
typedef void  *kustv_handle;    /* handle for TLV context */
...
kusst kuscx_allocate ( kuscx_handle *context_handle );
...
kusst kuscx_free_handle ( kuscx_handle *context_handle );
...
kusst kuscx_init ( kuscx_handle *context_handle );
...
kusst kusdb_allocate ( kusdb_handle *db_handle );
...
kusst kusdb_disconnect ( kusdb_handle db_handle );
...
kusst kusdb_free ( kusdb_handle *db_handle );
...
kusst kusdb_error_text ( kusdb_handle db_ctx, char *text_buf,
                          ub4 text_buf_len, ub4 *text_len_out );
...
kusst kustv_free_handle ( kustv_handle *tlv_handle );
...
kusst kussys_error_text ( char *text_buf,
                          ub4 text_buf_len, ub4 *text_len_out );
